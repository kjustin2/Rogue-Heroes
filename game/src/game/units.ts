...
export const TROOP_CATALOG: readonly TroopSpec[] = [
  ...
  { kind: "striker", label: "Striker", role: "Melee", cost: 220, cooldown: 2, tech: "assault", tip: "CHARGE: the strike order closes up to 5m for free before the blade lands, so anything within a lunge is already in reach." },
  ...
  { kind: "jumper", label: "Jump Trooper", role: "Vertical", cost: 240, cooldown: 2, tech: "assault", tip: "Jet pack. Its move is a jump: over cliffs, over water, over walls, onto the high ground — then it fires from up there. Land next to an enemy and the SLAM knocks it back and hurts. Airborne for the leap, so flak and interceptors can catch it mid-arc." },
  ...
  { kind: "sapper", label: "Scattergun", role: "Breacher", cost: 280, cooldown: 2, tech: "ordnance", tip: "Seven-pellet scattergun: brutal inside 5m and useless past 10 — the spread sweeps a whole clump at once. Also plants proximity mines ($15 each) and BREACH: one demolition round takes any wall or cover piece down in a single shot." },
  { kind: "tank", label: "Tank", role: "Armor", cost: 450, cooldown: 3, tech: "armor", tip: "Heavily armored bruiser: massive HP, big gun, and can ram and crush cover. HULL DOWN: a turn spent not moving settles it in — 30% less damage taken until it moves again." },
  ...
  { kind: "gunship", label: "Gunship", role: "Air", cost: 420, cooldown: 3, tech: "airwing", tip: "Fast flyer: overflies all terrain and cover. Its autocannon duels other aircraft; it drops bombs straight down on ground targets (fly over them, blast radius shown). Every move is a strafing run: one burst at each hostile within 4m of its path. Fragile — one flak burst threatens it — and it cannot capture." },
