...
export const TROOP_CATALOG: readonly TroopSpec[] = [
  ...
  { kind: "mortar", label: "Mortar Team", role: "Indirect", cost: 300, cooldown: 3, tech: "ordnance", tip: "High-arc fire over walls and ridges. SMOKE order: a 3-turn cloud that swallows flat shots; arcing rounds sail over." },
  ...
  { kind: "droneop", label: "Drone Operator", role: "Spotter", cost: 210, cooldown: 2, tech: "support", tip: "26m marker carbine and a spotter drone that sharpens nearby allies' fire. Paper-thin armour: keep it behind everything." },
  { kind: "jumper", label: "Jump Trooper", role: "Vertical", cost: 270, cooldown: 2, tech: "assault", tip: "Jet pack: its move is a leap over cliffs, water and walls. Landing beside an enemy SLAMS it. Flak can catch it mid-arc." },
  { kind: "flamer", label: "Flamer", role: "Burn", cost: 260, cooldown: 2, tech: "ordnance", tip: "Short-range flame projector. Hits leave burning ground for 2 turns: run, don't crouch. Its fuel tanks explode when shot." },
  { kind: "sapper", label: "Scattergun", role: "Breacher", cost: 240, cooldown: 2, tech: "ordnance", tip: "Scattergun: brutal inside 5m, useless past 10. Plants mines ($15) and BREACHES any wall or cover piece in one shot." },
  { kind: "tank", label: "Tank", role: "Armor", cost: 400, cooldown: 3, tech: "armor", tip: "Massive HP, big gun, rams and crushes cover. HULL DOWN: a turn spent still takes 30% less damage until it moves." },
  ...
  { kind: "gunship", label: "Gunship", role: "Air", cost: 400, cooldown: 3, tech: "airwing", tip: "Overflies all terrain. Autocannon duels aircraft; bombs drop straight down on ground targets. Fragile to flak; cannot capture." },
